...
class GeolocatorPage extends StatefulWidget {
  const GeolocatorPage({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<GeolocatorPage> createState() => GeolocatorPageState();
}

class GeolocatorPageState extends State<GeolocatorPage> {
